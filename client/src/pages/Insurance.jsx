...
const Insurance = () => {
  ...
  const insurancePlans = [
    ...
    },
    {
      ...
      description: 'Maximum protection with zero excess for complete peace of mind',
  ...
  const coverageDetails = [
    {
      ...
      description: 'Covers damage to the rental vehicle in case of collision or rollover'
    },
    {
    ...
    },
    {
      ...
      description: 'Medical expenses and accidental death coverage for you and passengers'
    },
    {
      icon: assets.bagIcon,
      title: 'Personal Effects Coverage',
      description: 'Coverage for personal belongings stolen from the rental vehicle'
    },
    {
      icon: assets.phoneIcon,
      title: 'Roadside Assistance',
      description: '24/7 emergency roadside assistance for breakdowns and emergencies'
    },
    {
      icon: assets.documentIcon,
      title: 'Legal Liability',
      description: 'Protection against third-party property damage and injury claims'
    }
  ]

  const faqs = [
    {
      question: 'Do I need rental car insurance if I have personal auto insurance?',
      answer: 'While your personal auto insurance may provide some coverage, it often has limitations for rental cars. Our insurance plans provide additional protection and eliminate gaps in coverage.'
    },
    {
      question: 'What does "excess" mean?',
      answer: 'Excess is the amount you pay out-of-pocket before insurance coverage kicks in. Our Premium Protection plan offers zero excess, meaning you pay nothing for covered damages.'
    },
    {
      question: 'Can I purchase insurance after my rental begins?',
      answer: 'Insurance must be purchased at the time of rental. It cannot be added retroactively after your rental period has started.'
    },
    {
      question: 'Are there any exclusions to the coverage?',
      answer: 'Yes, standard exclusions include damage due to negligence, driving under the influence, off-road driving, and using the vehicle for commercial purposes. Full terms are provided with your policy.'
    }
  ]
    ...
    <div className='min-h-screen'>
      ...
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 py-16 max-w-7xl mx-auto'>
        ...
        >
          ...
          >
            Select the insurance plan that best fits your travel needs and budget. All plans include comprehensive coverage and 24/7 support.
          </motion.p>
            ...
            {insurancePlans.map((plan, index) => (
              ...
              >
                ...
                <div className='text-center mb-6'>
                  ...
                  <div className='text-sm text-gray-500 mt-1'>Coverage: {plan.coverage}</div>
                </div>
            ...
            {coverageDetails.map((coverage, index) => (
              ...
              >
                <div className='w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4'>
                  <img src={coverage.icon} alt={coverage.title} className='w-8 h-8' />
                </div>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            ...
            >
              <div className='text-center'>
                ...
                <div className='text-gray-600 mb-6'>Customer Satisfaction Rate</div>
                
                <div className='text-3xl font-bold text-primary mb-2'>< 2 hours</div>
                <div className='text-gray-600 mb-6'>Average Claim Processing Time</div>
