        ...
        >
          ...
          >
            ...
            <p className='text-gray-700 leading-relaxed'>
              Cookies are small text files that are stored on your device when you visit our website. They help us provide you with a better experience by remembering your preferences, analyzing website traffic, and delivering personalized content.
            </p>
          </motion.div>
          ...
          >
            This Cookie Policy explains what cookies are, how we use them, and how you can manage your cookie preferences. By continuing to use our website, you consent to our use of cookies in accordance with this policy.
          </p>
        </motion.div>
              ...
              >
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    {item.required ? 'Required for website functionality' : 'Optional - can be disabled'}
                  </p>
                </div>
                <div className='flex items-center'>
                  {item.required ? (
                    <span className='text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded'>Always Active</span>
                  ) : (
          ...
          <div className='space-y-8'>
            {cookieTypes.map((cookie, index) => (
              ...
              >
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>{cookie.description}</p>
              ...
              <tbody className='divide-y divide-gray-200'>
                {cookieDetails.map((cookie, index) => (
                  ...
                  >
                    ...
                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-700'>{cookie.expiry}</td>
                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-700'>{cookie.domain}</td>
                  </motion.tr>
                ))}
              </tbody>
            </table>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            ...
            >
              ...
              <p className='text-gray-700 mb-4 text-sm leading-relaxed'>
                Most web browsers allow you to control cookies through their settings. You can usually find these options in the "Privacy" or "Security" section of your browser's settings.
              </p>
            ...
            >
              ...
              <p className='text-gray-700 mb-4 text-sm leading-relaxed'>
                You can also opt out of certain third-party cookies directly through the companies that provide them:
              </p>
              <ul className='text-sm text-gray-600 space-y-2'>
